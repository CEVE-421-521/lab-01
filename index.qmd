---
title: "Lab 01: Software Installation"
...
format: 
    html: default
# uncomment one of the following sections to render to PDF or word
...
This will install Julia 1.9.4 and make it the default version, which should maximize package compatibility throughout this course.
...
Like many editors, VS Code is a modular system that can be extended with plugins.
