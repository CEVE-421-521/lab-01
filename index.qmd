...
In this class, we will use three key software tools: Julia, GitHub, and Quarto.
We will generally also use the Visual Studio Code (VS Code) text editor, but you can use any text editor you like.

See [the Software Installation Guide](https://ceve-421-521.github.io/resources/setup.html) for more details and resources!
